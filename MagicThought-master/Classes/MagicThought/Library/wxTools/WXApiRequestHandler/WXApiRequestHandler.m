            ...
            InViewController:(UIViewController *)viewController
{
    ...
    req.state = state;
    req.openID = openID;
    NSLog(@"sendAuthRequestScope = %@", viewController);
...
+(void)jumpToWechatPayWithPartnerId:(NSString*)partnerId PrepayId:(NSString*)prepayId NonceStr:(NSString*)nonceStr TimeStamp:(NSTimeInterval)timeStamp Package:(NSString*)package Sign:(NSString*)sign
{
